...
2.2 Todo ingresso de tokens BALLX no ecossistema ocorrerá exclusivamente por meio de: a) Carteiras institucionais BALLX; b) Operações de cashback; c) Prêmios por desempenho, metas ou campanhas; d) Comissões operacionais; e) Créditos vinculados às atividades reais dentro da plataforma.

2.3 Qualquer referência anterior a "doação", "doação inicial" ou "doação automática" passa a ser interpretada automaticamente, para todos os efeitos, como crédito operacional em carteira institucional BALLX, sem transferência de propriedade irrestrita.
...
3.2 Toda a receita gerada no ecossistema BALLX, incluindo taxas, comissões e operações comerciais, será distribuída da seguinte forma: a) 20% (vinte por cento) destinados à ONG BALLX, exclusivamente para fins sociais e institucionais; b) 80% (oitenta por cento) destinados à BALLX GLOBAL, como receita operacional, tecnológica e estratégica.

3.3 A ONG BALLX não possui poder de governança operacional, controle sobre carteiras ou ingerência sobre tokens, atuando exclusivamente como beneficiária social do ecossistema, conforme percentuais aqui definidos.
...
4.2 A utilização da BALLX como forma de cashback, premiação, ingresso, pagamento parcial ou integral é facultativa, sendo de livre decisão de cada clube, liga, vendedor ou lojista: a) Aceitar ou não a BALLX como retorno ao consumidor; b) Definir em quais produtos, serviços ou campanhas o BALLX será utilizado; c) Decidir se utilizará o BALLX para premiações, entradas de eventos, ingressos ou outras finalidades internas.

4.3 A BALLX não impõe obrigações de aceitação, nem caracteriza relação de pagamento compulsório, tratando-se de um benefício digital de uso opcional, sem promessa de retorno financeiro, aceito somente quando houver concordância expressa do participante.
...
5.1.1 Do Fundo de Suporte ao Resgate: Parte dos recursos administrativos do ecossistema (equivalente a 20% do valor das taxas administrativas apuradas) é destinada a um fundo de suporte que garante aos usuários opções de resgate do benefício BALLX — seja para uso em produtos e serviços dentro da plataforma, seja para conversão em valor, nos mesmos moldes de programas de cashback e fidelidade consolidados no mercado de varejo. O propósito é exclusivamente oferecer opções reais de uso ao usuário — nunca constituir promessa de valorização do token ou garantia de retorno financeiro.

5.1.2 Da Ausência de Responsabilidade sobre Terceiros: A BALLX não se responsabiliza, garante ou referencia liquidez disponibilizada por corretoras centralizadas ou descentralizadas de terceiros. As opções de resgate tratadas nesta cláusula referem-se exclusivamente ao fundo de suporte mantido pela própria plataforma BALLX, e não a qualquer mercado externo.

5.1.3 Da Interface Oficial: quando disponibilizado, o aplicativo Web3 oficial da BALLX interagirá exclusivamente com o(s) contrato(s) inteligente(s) oficiais do ecossistema, sem integração com corretoras, exchanges, DEX ou contratos de terceiros, reforçando o caráter fechado do fundo de suporte tratado no item 5.1.1.
...
5.3 Gotejamento por Acumulação (Titulares): Para contas com saldo a partir de 120.000 BALLX, aplica-se a liberação controlada de 10% ao ano, distribuída proporcionalmente em 12 parcelas mensais (~0,833% ao mês). O limite mensal final desses usuários será de 10.000 BALLX + o gotejamento do saldo.

5.4 Cálculo de Excedente Dinâmico: O sistema monitora o topo histórico de saldo de cada carteira em tempo real através da rede Polygon. Caso o usuário aumente seu saldo de forma legítima, o contrato recalcula o limite sobre o valor excedente e libera a nova cota cumulativa imediatamente, reiniciando o ciclo de 30 dias.

5.5 O vesting tem como objetivo:

a) Garantir a sustentabilidade do fundo de resgate;

b) Evitar concentração e uso desequilibrado dos benefícios;

c) Garantir o crescimento orgânico e sustentável do ecossistema.
...
6.3 A ORIAH poderá: a) Monitorar movimentações internas e externas; b) Bloquear movimentação em violação do vesting; c) Registrar auditorias e eventos de controle; d) Aplicar medidas corretivas automáticas quando necessário.
...
7.2 A ORIAH atuará de forma independente, imparcial e em tempo real para: a) Monitorar e cruzar dados de transações internas e externas; b) Verificar a conformidade com as regras de aquisição, uso e governança; c) Fiscalizar uso indevido do token fora das diretrizes do ecossistema; d) Detectar excessos, manipulações, fraudes ou desvios; e) Emitir alertas automáticos de risco; f) Bloquear carteiras, limitar transações, reverter transações ou iniciar auditorias automáticas quando necessário.

7.3 Toda atuação da ORIAH será registrada em logs técnicos e, quando aplicável, em blockchain, garantindo: a) Transparência do sistema; b) Rastreabilidade imutável; c) Proteção contra decisões que comprometam a integridade, a ética ou a sustentabilidade do projeto.
...
8.2 O direito de voto será exercido por meio: a) Da plataforma web oficial da BALLX; b) Do aplicativo oficial da BALLX; c) De mecanismos on-chain ou híbridos validados pela ORIAH.
...
9.3 A definição de como a ONG aplicará seus recursos será tomada de forma coletiva pela diretoria da ONG, respeitando seus critérios internos, estatuto e finalidades sociais.

9.4 A ONG BALLX não possui: a) Poder de governança operacional; b) Controle sobre carteiras; c) Poder decisório sobre o token; d) Responsabilidade pela adesão, disponibilidade ou circulação da BALLX.
...
10.2 A receita apurada será distribuída automaticamente da seguinte forma: a) 80% (oitenta por cento) destinados à BALLX GLOBAL, para custeio operacional, tecnológico, estratégico, expansão do ecossistema, segurança, desenvolvimento e sustentabilidade do projeto; b) 20% (vinte por cento) destinado à ONG BALLX, exclusivamente para fins sociais, esportivos, educacionais e comunitários.

10.3 O repasse à ONG BALLX não caracteriza participação societária, controle operacional, cogestão ou qualquer direito sobre o token, contratos, carteiras ou decisões estratégicas da BALLX GLOBAL.

10.4 A BALLX GLOBAL não possui obrigações de distribuição de lucros, recompra de tokens ou garantia de valorização, sendo a BALLX um benefício digital de uso voluntário dentro do ecossistema, não caracterizando valor mobiliário, ativo financeiro ou instrumento de investimento.
...
11.2 A inteligência artificial ORIAH supervisionará permanentemente: a) A circulação dos tokens; b) O cumprimento das regras de aquisição; c) O uso adequado das carteiras institucionais; d) A estabilidade e integridade do ecossistema.

11.3 Em caso de fraude, manipulação, tentativa de uso indevido do token ou violação das diretrizes éticas do projeto, a ORIAH está autorizada a: a) Bloquear carteiras; b) Reverter transações; c) Suspender benefícios; d) Realizar auditorias automáticas; e) Queimar tokens, inclusive tokens vinculados à BALLX GLOBAL, se necessário para preservação e integridade do ecossistema.
...
12.2 Qualquer alteração futura deste contrato somente poderá ocorrer mediante: a) Proposta formal registrada na plataforma; b) Validação técnica da IA ORIAH; c) Processo de governança participativa conforme definido neste instrumento.
...
12.5 Este contrato entra em vigor na data de sua publicação oficial pela BALLX GLOBAL, vinculando automaticamente todos os participantes do ecossistema que utilizam, detenham ou aceitam tokens BALLX.
...
Sua finalidade é estabelecer, de maneira clara, objetiva e permanente, as regras de operação, governança, fiscalização, sustentabilidade e responsabilidade social do projeto BALLX.

A BALLX GLOBAL é reconhecida como titular exclusiva da operação, da infraestrutura, dos contratos, das carteiras institucionais, da tecnologia e da gestão do ecossistema, preservada a destinação social de parte da receita à ONG BALLX, nos termos aqui definidos.
...
Nenhuma delas detém titularidade patrimonial, controle operacional ou poder de decisão sobre o token, contratos ou ativos do ecossistema.
